...
def upgrade() -> None:
    ...
    categorization_status_enum = postgresql.ENUM("UNCATEGORIZED", "CATEGORIZED", "FAILURE", name="categorizationstatus")
    ...
    job_status_enum = postgresql.ENUM("PENDING", "IN_PROGRESS", "COMPLETED", "FAILED", "CANCELLED", name="jobstatus")
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("account_id", "balance_date", name="uq_initial_balance_account_date"),
    )
    ...
    op.create_table(
        ...
        sa.Column("account_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("counterparty_account_id", postgresql.UUID(as_uuid=True), nullable=True),
        sa.Column("categorization_status", categorization_status_enum, nullable=False),
        sa.Column("categorization_confidence", sa.Numeric(precision=5, scale=4), nullable=True),
        sa.Column("counterparty_status", counterparty_status_enum, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("source", categorization_source_enum, nullable=False),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(
            ["category_id"],
    ...
    op.create_index(op.f("ix_file_analysis_metadata_file_hash"), "file_analysis_metadata", ["file_hash"], unique=False)


def downgrade() -> None:
    # Drop indexes
    op.drop_index(op.f("ix_file_analysis_metadata_file_hash"), table_name="file_analysis_metadata")
    op.drop_index(op.f("ix_transaction_categorization_normalized_description"), table_name="transaction_categorization")
