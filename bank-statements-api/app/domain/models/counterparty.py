...
class CounterpartyResult:
    """Result of identifying a counterparty for a single transaction"""
...
@dataclass
class BatchCounterpartyResult:
    """Result of identifying counterparties for a batch of transactions"""

    results: List[CounterpartyResult]
    total_processed: int
    ...
    def success_rate(self) -> float:
        """Calculate the success rate of the batch counterparty identification"""
