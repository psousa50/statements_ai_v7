...
class TransactionCategorization(Base):
    ...
    source = Column(
        SQLAlchemyEnum(CategorizationSource),
        nullable=False,
    )
    ...
    def __repr__(self):
        return f"<TransactionCategorization(id={self.id}, normalized_description={self.normalized_description}, category_id={self.category_id}, source={self.source})>"
